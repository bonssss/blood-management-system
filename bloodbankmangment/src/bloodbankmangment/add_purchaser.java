 ...
 * @author mesi
 */
public class add_purchaser extends javax.swing.JFrame {

    /**
     * Creates new form add_donor
     */
    public add_purchaser() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ADD NEW PURCHASER");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String query="INSERT INTO purchaser(name,Age,Phone,Gender,BloodGroup,city) VALUES(";
            query = query  + "'"+Name+ "',";
            query = query + Age + ",";
            query = query + Phone + ",";
            query = query  + "'"+ Gender + "',";
            ...
            con.close();
                ...
                Logger.getLogger(add_purchaser.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_purchaser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
