...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Update Donor Record");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(239, 7, 309, 55);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            String sql = "UPDATE donors SET name=?,Age=?,Phone=?,Gender=?,city=?,BloodGroup=? WHERE id =" +ID;
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/bloodbank", "root", "");
            Statement st = con.createStatement();
                  st.executeUpdate("UPDATE donors SET name='"+Name+"',Age='"+Age+"',Phone='"+PHone+"',Gender='"+Gender+"',BloodGroup='"+bloodtype+"',city='"+City+"' WHERE id ='" +ID+"'");
